...
const PersonalWebsite = () => {
  ...
  const blogPosts = [
    {
      id: 'dont-network-exchange-ideas',
      title: "Don't Network → Exchange Ideas",
      date: "March 2026",
      summary: "Why genuine curiosity and idea exchange beats transactional networking every time.",
      content: `"Networking is overrated… Do something great and your network will instantly emerge." - Naval Ravikant

The primary audience for this article is college going kids or even high-school folks looking to connect with people in hope of an internship or a full-time job, especially at places where you're not treated as a cog in the machine. It may also broadly apply to people doing business.

I was just taking a quick break from helping dad through his post-op things at the hospital. The past few nights were spent delivering on some critical work assignments from the seats outside the ward. I didn't know there was this junior year (third-year) CS major lurking and seeing someone ask Claude Code to code. The next morning (serendipitously) we met in the elevator. He asked me if I was a coder? I was a bit surprised, because I didn't know this kid. So I asked him and he answered honestly that he was watching me code the night before and said he also wants to be able to land a gig where he can do what he's learning full-time. I asked him what he does and in the process he told me of this interesting supply-chain software product he worked on at his internship. The boy didn't shy from going deep and shared enough that I learned about this specific supply-chain problem that his internship client (Fortune 100) faced.

No, he didn't ask me if I worked at a specific tech company, although he must've looked it up. He didn't ask me whether I'd offer him a referral. He just exchanged ideas. It is probably true that he had the intent to ask, but chose to collaborate on ideas with me in that short elevator pitch. That drew me more to speaking to him, because I wasn't "helping", I was "learning", speaking to someone who I could also gain some value from. I think most college going kids get this wrong. There's a class of them that think process is what gets them an interesting gig - this is wrong 9 times out of 10. And, then there's another class that doesn't shy from asking for referrals and favors before even introducing who they are - in general, it's a task to help them and as human beings, however altruistic we may claim to be, we don't like doing more tasks.

If you have something interesting to contribute to the discussion, people want to engage with you and help you. In fact, they seek to help you. A meta interpretation of Naval's quote at the top of the article can be applied to this as well i.e. your network instantly emerging is people coming to your aid because they think you have something to offer (even if not to them, to the world). But, being that, requires practice, a curiosity to learn, and to take a step back and focus on the conversation instead of what you plan to "get" out of it. Even more fundamentally, it requires you to have done something. It doesn't matter if you didn't work at a skilled job before, what matters is how you tried to fill that gap. What was so interesting about that skill that made you go out of the way and do a side-project. Your passion will show and the right people will recognize it almost instantly.

There's a way you can weave things into the conversation, if you do want to ask for a favor such as getting referred, but that's a conversational art and really doesn't require any kind of linguistic-gymnastics. All it needs is a genuine interest in conversation with some idea of what you'd want to ask probably towards the end of such a conversation. Treat that as a side-effect and enter the conversation with a genuine curiosity and willingness to share what you learnt.`
    },
    {
